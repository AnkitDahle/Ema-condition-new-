...
def get_custom_css(active_index):
    ...
    div[data-testid="stHorizontalBlock"]:first-of-type div[data-testid="stColumn"]:nth-child(ACTIVE_TAB_INDEX) .stButton > button p { color: #00e5ff !important; font-weight: 900 !important; text-shadow: 0 0 14px rgba(0,229,255,0.5); }
    ...
    @media (max-width: 768px) { div[data-testid="stHorizontalBlock"]:first-of-type { display:flex !important; flex-wrap:nowrap !important; overflow-x:auto !important; padding-bottom:5px !important; } div[data-testid="stHorizontalBlock"]:first-of-type > div[data-testid="stColumn"] { min-width:max-content !important; flex:0 0 auto !important; width:auto !important; } div[data-testid="stHorizontalBlock"]:first-of-type::-webkit-scrollbar { display:none; } .page-heading { font-size: 26px; } }
    ...
    return css_template.replace("ACTIVE_TAB_INDEX", str(active_index))
