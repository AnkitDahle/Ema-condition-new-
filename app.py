...
if st.session_state.current_page == "Home":
    ...
    if st.session_state.current_page == "Scanner":
        ...
        # 🔥 CALCULATOR SHIFTED TO JOURNAL TABS
        if is_admin:
            j_tabs = st.tabs(["➕ New Trade", "🔄 Update Exits", "📚 Journal Gallery", "🧮 Risk Calculator"])
            tab_gallery = j_tabs[2]
            tab_calc = j_tabs[3]
            ...
            j_tabs = st.tabs(["📚 Journal Gallery", "🧮 Risk Calculator"])
