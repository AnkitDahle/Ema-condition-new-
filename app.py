...
# ==========================================
# 3. 🎨 UI ENGINE & CUSTOM CSS (NEW PREMIUM DESIGN)
# ==========================================
custom_css = f"""
...
.page-heading, .journal-card, div[data-testid="stMetric"], .stPlotlyChart {{
...
div[data-testid="stHorizontalBlock"]:first-of-type .stButton > button p {{
    color: #7b8fa3 !important; font-weight: 600 !important; font-size: 16px !important;
    letter-spacing: 0.4px; white-space: nowrap !important;
    transition: all 0.2s ease;
}}
div[data-testid="stHorizontalBlock"]:first-of-type .stButton > button:hover p {{
    color: #ffffff !important; text-shadow: 0 0 12px rgba(0,229,255,0.6);
}}
...
div[data-testid="stHorizontalBlock"]:first-of-type button[kind="primary"] {{
    ...
    border-radius: 8px !important; border: none !important; white-space: nowrap !important;
...
div[data-testid="stHorizontalBlock"]:first-of-type button[kind="primary"]:hover {{
    transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,229,255,0.5) !important;
}}
...
.login-container {{
    background: rgba(0,0,0,0.4); padding: 44px; border-radius: 18px;
    border: 1px solid rgba(255,255,255,0.1); backdrop-filter: blur(12px);
    max-width: 400px; margin: 5vh auto auto; text-align: center;
